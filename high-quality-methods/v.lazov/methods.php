...
class Helper {
	static calculate_triangle_area($a, $b, $c) {
		if ($a <= 0 || $b <= 0 || $c <= 0) {
	...
	static find_max_number($elements) {
	...
	static print_formatted_number($number, $format) {
	...
	static calculate_distance($x1, $y1, $x2, $y2) {
		/*
		WTF C# shit ...
		isHorizontal = (y1 == y2);
		isVertical = (x1 == x2); */
